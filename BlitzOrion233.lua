...
local bottomChildren = {
    ...
    -- プレイヤー名ラベル
    AddThemeObject(SetProps(MakeElement("Label", LocalPlayer.DisplayName, HidePremium and 14 or 13), {
        Size = UDim2.new(1, -60, 0, 13),
        Position = HidePremium and UDim2.new(0, 50, 0, 19) or UDim2.new(0, 50, 0, 12),
        Font = Enum.Font.GothamBold,
    ...
    AddThemeObject(SetProps(MakeElement("Label", labelText, 12), {
        ...
        Visible = not HidePremium
    }), "TextDark"),

    -- フレンド数ラベル
    AddThemeObject(SetProps(MakeElement("Label", "People: Loading...", 12), {
...
local function UpdatePlayerInfo()
    ...
    for _, child in ipairs(WindowStuff:GetDescendants()) do
        if child:IsA("TextLabel") then
            -- フレンド数更新
            if child.Text:find("Friends:") then
            ...
            -- Owner/Member ラベルの動的更新（必要に応じて変更可）
